...
export default function Dashboard() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'patients' | 'notifications' | 'reports' | 'profile'>('overview')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <div>
                <h1 className="text-lg font-bold text-medical-600">MediReminder</h1>
          ...
          <div className="animate-fade-in space-y-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-[2rem] p-8 border border-medical-100 shadow-sm flex items-center justify-between group hover:border-medical-300 transition-all cursor-pointer" onClick={handleTestNotification}>
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800">Alert System Test</h4>
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Ensure notifications are working</p>
                    </div>
                  </div>
