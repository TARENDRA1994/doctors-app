          ...
          <div className="animate-fade-in space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div
                ...
                className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-6 text-white cursor-pointer shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16 group-hover:scale-150 transition-transform duration-500"></div>
                <div className="flex justify-between items-start relative z-10">
                  <div>
                    <h3 className="text-xl font-bold mb-1">Calendar</h3>
                    <p className="text-teal-100 text-sm">Monthly Schedule View</p>
                  </div>
                  <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
