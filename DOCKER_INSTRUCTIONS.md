# Docker Deployment Guide for DoctorsNode

This guide explains how to build and run the DoctorsNode application in a separate VM or container using Docker.
...
```bash
docker build -t doctorsnode-app .
```
