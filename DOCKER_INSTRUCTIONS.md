# Docker Deployment Guide for HealthNuero

This guide explains how to build and run the HealthNuero application in a separate VM or container using Docker.
...
```bash
docker build -t healthnuero-app .
```
