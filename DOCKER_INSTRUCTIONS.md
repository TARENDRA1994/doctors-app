# Docker Deployment Guide for MediReminder

This guide explains how to build and run the MediReminder application in a separate VM or container using Docker.
...
```bash
docker build -t medireminder-app .
```
